        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">ChurchManager<span className="text-sakura-300">JP</span></span>
            </Link>
            <p className="mt-4 text-gray-300">
              Complete church management solution for religious organizations in Japan.
            </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0">
              <div className="flex space-x-4">
                ...
                <button className="text-gray-300 hover:text-white">Português</button>
                <button className="text-gray-300 hover:text-white">Español</button>
              </div>
            </div>
          </div>
        </div>
